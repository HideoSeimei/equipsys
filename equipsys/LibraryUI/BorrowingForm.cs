    ...
    public partial class BorrowingForm : Form
    {
        ...
        private void BorrowBTN_Click(object sender, EventArgs e)
        {
            if (ValidateForm())
            {
                ...
                cmd.CommandText = "insert into BorrowerHistory values ('" + FirstNameValue.Text + "', '" + LastNameValue.Text + "', '" + CourseValue.Text + "', '" + YearValue.Text + "','" + SectionValue.Text + "','" + StudentIDValue.Text + "','" + ContactNumberValue.Text + "', '" + EmailValue.Text + "', '" + BorrowingItemName.Text + "', '" + Int32.Parse(BorrowStockValue.Text) + "', '" + TimeNow + "', '" + EndTimeValue.Text + "','" + randomID + "', 'Ongoing')";
